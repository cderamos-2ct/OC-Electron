      ...
      renderers={{
        "models.providers": () => (
          ...
          >
            ...
            {!isConnected ? (
              <div className="mb-4 flex items-center gap-2 rounded-lg px-4 py-3 text-sm" style={{ background: "var(--background)", color: "var(--text-secondary)" }}>
...
function ModelCard({ model }: { model: ModelChoice }) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 break-all text-xs font-mono" style={{ color: "var(--text-secondary)" }}>
